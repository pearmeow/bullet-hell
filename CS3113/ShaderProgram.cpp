...
void ShaderProgram::setFloat(const std::string& name, float value) {
    ...
    int locationID = GetShaderLocation(mShader, name.c_str());
    if (locationID != NOT_LOADED) SetShaderValue(mShader, locationID, &value, SHADER_UNIFORM_FLOAT);
}
...
void ShaderProgram::setInt(const std::string& name, int value) {
    ...
    int locationID = GetShaderLocation(mShader, name.c_str());
    if (locationID != NOT_LOADED) SetShaderValue(mShader, locationID, &value, SHADER_UNIFORM_INT);
}
